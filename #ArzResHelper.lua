        ...
        while true do
            ...
            if status == "completed" then
                ...
                if success and doesFileExist(zipPath) then
                    ...
                    local cmd = 'powershell -WindowStyle Hidden -NoProfile -ExecutionPolicy Bypass -command "$sh=New-Object -ComObject Shell.Application;$sh.Namespace(\\"' .. dirml .. '\\").CopyHere($sh.Namespace(\\"' .. zipPath .. '\\").Items(),20)"'
                    ...
                    lua_thread.create(function()
                        ...
                        while true do
                            ...
                            if exStatus == "completed" or exStatus == "canceled" then
                                pcall(function() extractReq:get() end)
                                break
                            elseif os.time() - exStart > 60 then
                                pcall(function() extractReq:cancel() end)
                                sampAddChatMessage(SCRIPT_PREFIX .. "Таймаут распаковки ресурсов.", SCRIPT_COLOR)
                                break
                            end
                            wait(0)
                        end

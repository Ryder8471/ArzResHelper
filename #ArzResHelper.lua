...
function drawSettingsTab()
    ...
    drawList:AddText(imgui.ImVec2(cardX + 35, cardY + (cardH - 14) / 2), titleCol, u8("Таймер"))
    imgui.SetCursorScreenPos(imgui.ImVec2(cardX, cardY))
    ...
    if settingsExpandedOverlayStyle then
        ...
        imgui.Separator()
        imgui.Spacing()
        imgui.TextColored(imgui.ImVec4(1.0, 0.8, 0.2, 1), u8("Сброс отображаемых данных в оверлее"))
        imgui.Spacing()
    ...
    if #allDates > 0 then
        ...
        if selectedDate and logCount > 0 then
            ...
            elseif imTabIdx.v == 1 then
                ...
                drawList:AddText(imgui.ImVec2(hdrX + listW / 2 - nickHdrW / 2, hdrY + 3), tableHdrText, nickHdr)
            ...
            elseif hasResources then
                ...
                if imgui.IsItemHovered() then
                    ...
                    if lbServerFilter.v > 0 then
                        imgui.TextColored(imgui.ImVec4(1.0, 0.8, 0.2, 1), u8("Активен: ") .. serverListClean[lbServerFilter.v + 1])
                    end
                    imgui.EndTooltip()
                end

            ...
            if totalAmount > 0 or paydayAZ > 0 then
                ...
                if tgConfig.enabled and tgConfig.paydayEnabled then
                    ...
                    local msg = "&#128176; <b>Вы получили пейдей!</b>\n\n" ..
                                "<b>Вот статистика:</b>\n\n" ..
                                "&#128178; Получено с зарплаты: <b>" .. formatNumber(paydaySalary) .. "$</b>\n" ..
                                "&#128179; Получено с депозита: <b>" .. formatNumber(paydayDeposit) .. "$</b>\n" ..
                                "&#128085; Получено с аксессуаров/предметов: <b>" .. formatNumber(paydayAccBonus) .. "$</b>\n\n" ..
                                "&#128142; Получено AZ: <b>" .. formatNumber(paydayAZ) .. "</b>\n\n" ..
                                "&#128200; Ваш общий доход: <b>" .. formatNumber(totalAmount) .. "$ | " .. formatNumber(paydayAZ) .. " AZ</b>\n\n" ..
                                "&#128338; Время: " .. timeStr .. " (МСК)\n" ..
                                "&#128197; Дата: " .. dateStr
...
if tgConfig.itemMarketEnabled and amount >= 0 then
    ...
    if text:match("^Вам был добавлен предмет") then
        ...
        if itemId then
            ...
            -- Талон AZ (работает если включено авто-сканирование)
...
sampRegisterChatCommand("rh", function() 
    ...
    -- Инициализация кэша для талона AZ (ID 731)
    ...
    -- Авто-сканирование инвентаря для талона AZ при старте (если включено)

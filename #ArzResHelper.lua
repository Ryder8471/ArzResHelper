...
function hook.onServerMessage(color, text)
    ...
    table.remove(paydayLog, #paydayLog) 
                ...
                savePaydayStats()
                -- Telegram уведомление о пейдее (отложенная отправка)
                if tgConfig.enabled and tgConfig.paydayEnabled then
                    ...
                    lua_thread.create(function()
                        wait(2000) -- задержка 2 секунды после пейдея
                        ...
                        local msg = "&#128176; <b>Вы получили пейдей!</b>\n\n" ..
                                    ...
                                    "&#128200; Ваш общий доход: <b>" .. formatNumber(savedTotal) .. "$ | " .. formatNumber(savedAZ) .. " AZ</b>\n\n" ..
                                    "&#128338; Время: " .. timeStr .. " (МСК)\n" ..
                                    "&#128197; Дата: " .. dateStr

        ...
        elseif select_menu[5] then
            ...
            if #bindDatabase.binds == 0 then
                imgui.Text(u8("Нет биндов. Создайте новый!"))
                              ...
                              local r, g, b
                if useCustomTheme then
                    r, g, b = theme.rightPanelBg.x, theme.rightPanelBg.y, theme.rightPanelBg.z
                else
                    local bg = theme.rightPanelBg
                    b = math.floor((bg % 0x1000000) / 0x10000) / 255
                    g = math.floor((bg % 0x10000) / 0x100) / 255
                    r = math.floor(bg % 0x100) / 255
                end
                ...
                for key, val in ipairs(bindDatabase.binds) do
                    ...
                    drawList:AddRect(
                        ...
                        imVec4ToHex(theme.borderActive), 4, 15, 2.0
                    )
